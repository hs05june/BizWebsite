        ...
        <AboutStyled>
            <table className='portTable'>
                ...
                <div className='nothing'>
                    ...
                    <div className='side'>
                    <p style={{fontFamily:'Inter',color:'rgba(0,0,0,0.5)',fontWeight:'400',alignContent:'center',fontSize:'1.5vw'}}>Looks like we will have to wait until your bank becomes investment<br/> ready.</p>
                    <p style={{fontFamily:'Inter',color:'rgba(0,0,0,0.5)',fontWeight:'600',alignContent:'center',marginLeft:'10vw',fontSize:'1.5vw'}}>Get ready to start investing.</p>
                    </div>
                </div>
                {/* <tr className='element'>
                    <td style={{display:'inline-block',width:'18vw',textAlign:'left',fontWeight:'600'}}>Bharat Petroleum</td>
